...
public class AddResult1 extends HttpServlet {
	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(rows == 1) {
			response.sendRedirect("/add-result-mvc1/addResultSuccess.html");
		}else {
			response.sendRedirect("/add-result-mvc1/addResultFailure.html");
		}
	}
}
